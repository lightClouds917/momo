...
public class ConnectionProxy implements Connection {
     ...
     * connection, or the given parameter is not a <code>ResultSet</code> constant indicating
     * holdability
     ...
     *
     * <p> if setSavepoint is invoked outside of an active transaction, a transaction will be
     * started at this newly created savepoint.
     *
     ...
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method or
     * this method is not supported for the specified result set type, result set holdability and
     ...
     * one of <code>Statement.RETURN_GENERATED_KEYS</code> or <code>Statement.NO_GENERATED_KEYS</code>
     * @return a new <code>PreparedStatement</code> object, containing the pre-compiled SQL
     ...
     * client info value on the database server or this method is called on a closed connection <p>
     * @since 1.6
     */
    @Override
